...
internal abstract class CommandHandler<TCommand>(ILogger logger) where TCommand : ICommand
{
...
internal abstract class CommandHandler<TCommand, TResult>(ILogger logger) where TCommand : ICommand
{
    protected abstract string CommandName { get; }
